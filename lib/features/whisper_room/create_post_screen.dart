...
class _CreatePostScreenState extends ConsumerState<CreatePostScreen> {
  ...
  Future<void> _pickImage() async {
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Image attachments are currently disabled.'),
        ),
      );
    }
  }
  ...
  Future<void> _publishPost() async {
    ...
    final newPost = CommunityPost(
      ...
      authorName: _isAnonymous ? 'Anonymous' : userProfile.username,
      authorAvatar: _isAnonymous ? '' : userProfile.avatarUrl,
    ...
    final published =
        await ref.read(whisperRoomProvider.notifier).addPost(newPost);
    ...
    if (published) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Could not publish your post. Please check your connection and try again.'),
        ),
      );
    }
  }
                        ...
                        children: [
                          ...
                          Text(
                            _isAnonymous
                                ...
                                : 'Posting as ${ref.watch(effectiveUserProfileProvider).username}',
                            style: GoogleFonts.inter(
                              fontSize: 11,
