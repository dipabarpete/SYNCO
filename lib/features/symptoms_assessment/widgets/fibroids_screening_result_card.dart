...
class UterineFibroidsScreeningResultCard extends StatelessWidget {
  ...
  const UterineFibroidsScreeningResultCard({
    super.key,
    required this.level,
    required this.title,
          ...
          if (reportedSymptoms.isNotEmpty) ...[
            ...
            for (final s in reportedSymptoms)
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.check_circle_outline, size: 14, color: AppColors.softPurple),
